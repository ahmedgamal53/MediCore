...
console.log(appointment);
   ...
   return(
          ...
          const totalPages=Math.ceil((appointment?.length||0)/itemsPerPage)
          const paginatedVisits=appointment?.slice(
          ...
          <div className="max-w-5xl">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-[0_10px_40px_rgba(15,23,42,.06)] p-6 md:p-8 mb-6 flex flex-col sm:flex-row sm:items-center gap-5">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-500 text-sm mt-0.5">Doctor Details</p>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition p-5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-900 text-lg font-semibold mt-0.5">{doctor?.phone || "-"}</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition p-5 flex items-start gap-3">
                ...
                <div>
                  <div className="text-slate-500 text-xs font-medium uppercase tracking-wide">Experience</div>
                  <div className="text-slate-900 text-lg font-semibold mt-0.5">{doctor?.experience} {doctor?.experience ? "yrs" : ""}</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition p-5 flex items-start gap-3">
                ...
                <div>
                  <div className="text-slate-500 text-xs font-medium uppercase tracking-wide">Specialty</div>
                  <div className="text-slate-900 text-lg font-semibold mt-0.5">{doctor?.specialty || "-"}</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition p-5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-900 text-lg font-semibold mt-0.5">{doctor?.currentstatus || "-"}</div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-[0_10px_40px_rgba(15,23,42,.06)] p-6 md:p-8">
              <div className="flex items-center justify-between mb-5">
                <div>
                  ...
                  <p className="text-slate-500 text-sm mt-0.5">Patients scheduled with this doctor</p>
                </div>
                <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-100">
                  {appointment?.length || 0} total
                </span>
              </div>
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {appt.patients?.Blood_Type && (
                            <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-red-50 text-red-500 border border-red-100">
                              <IoWaterOutline /> {appt.patients.Blood_Type}
                            </span>
                          )}
                          <span
